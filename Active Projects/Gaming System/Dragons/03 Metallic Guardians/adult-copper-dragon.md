...
lineage:
  - "[[active/Gaming System/Dragons/03 Metallic Guardians/young-copper-dragon]]"
...
- name: Breath Weapons (Recharge 5-6).
  desc: The dragon uses one of the following breath weapons. - **Acid Breath.** The
    dragon exhales acid in a 60-foot line that is 5 feet wide. Each creature in that
    line must make a DC 18 Dexterity saving throw, taking 54 (`12d8`) acid damage
    ...
    on a DC 18 Constitution saving throw. On a failed save, the creature can't use
